...
As usual, this paragraph begins with an unremarkable sentence that displays the default font family. \sffamily However, in the midst of this paragraph, a switch changes the font to sans-serif. This font will be used in the next paragraph, too!

This sentence continues in sans-serif until the next switch is encou\ttfamily ntered, and now the font-family is monospace. Rather than insert a code example into this code example to exploit this fixed-width text, \rmfamily the font family returns to serif for the rest of this document.
...
\ttfamily ``Well now, I dunno. There's something dreadful heathenish about it, seems to me. I'd ruther Jane or Mary or some sensible name like that. But when Diana was born there was a schoolmaster boarding there and they gave him the naming of her and he called her Diana.''
...
\rmfamily When they had driven up the further hill and around a corner Matthew said:

``We're pretty near home now. That's Green Gables over---''

% Blocks around switches
{\sffamily The text before this block is serif, but inside this block, a switch makes the text sans-serif!}

The switch's effect does not affect any text outside the block, and thus, the font is serif yet again.

{\ttfamily Inside this next block, the monospace switch makes the text fixed-width. Still no code examples within this code example exist to make this paragraph multiline.}

Externally, the text is serif and variable-width.

{\rmfamily A switch inside this block maintains the serif text, and no visual difference is apparent.}

As expected, the text is still serif here.
...
% Outside the above command, the previous switch was \ttfamily
